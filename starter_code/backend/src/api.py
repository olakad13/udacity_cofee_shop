...
def get_drinks():
    ...
    formatted_result = [drink.short() for drink in drinks]
    return jsonify({
        "success": True,
        "drinks": formatted_result
    })
...
def get_drinks_detail(payload):
    ...
    formatted_reult = [drink.long() for drink in drinks]
    return jsonify({
        "success": True,
        "drinks": formatted_reult
    })
